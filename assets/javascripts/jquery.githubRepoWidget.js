;jQuery(document).ready(function($){
	...
	$('.github-widget').each(function(){
		...
		if(i == 0) $('head').append(
			'<style type="text/css">'
			+'.github-widget{margin-bottom:8px;display:inline-block;}'
			+'.github-box *{-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;}'
			+'.github-box{width: 410px;font-family:helvetica,arial,sans-serif;font-size:13px;line-height:18px;background:#fafafa;border:1px solid #ddd;color:#666;border-radius:3px}'
			...
			+'.github-box .github-box-title .github-stats a{margin-left:5px;display:inline-block;height:21px;color:#666;border:1px solid #ddd;border-radius:3px;padding:0 5px 0 18px;background: white url('+stats_png+') no-repeat}'
			...
			+'.github-box .github-box-content p{margin:0;font-size:15px;}'
			...
			+'.github-box .description{font-size:13px !important;}'
			+'}'
			+'</style>'
		);
		i++;
